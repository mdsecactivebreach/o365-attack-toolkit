...
func GenerateUrl() {
	...
	phishURL, _ := fmt.Printf("https://login.microsoftonline.com/common/oauth2/v2.0/authorize?scope=%s&redirect_uri=%s&response_type=code&client_id=%s", model.GlbConfig.Oauth.Scope, model.GlbConfig.Oauth.Redirecturi, model.GlbConfig.Oauth.ClientId)
